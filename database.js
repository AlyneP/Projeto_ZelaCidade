...
const criarBanco = async () => {
    ...
    await db.exec(`
        CREATE TABLE IF NOT EXISTS incidentes (
            ...
            data_registro TEXT,              -- data do registro
            hora_registro TEXT,              -- hora do registro
            status_resolucao TEXT DEFAULT 'Pendente',
            imagem_problema  TEXT            -- Imagem do problema
        )
    `)

    console.log('Banco de dados configurado: A tabela de registros urbanos está bronta ')

    
    // VERIFICAÇÃO DE DUPLICIDADE - criar variável 
    ...
    // Fazer uma condicional (VERIFICICAÇÃO - SE E SENÃO)
